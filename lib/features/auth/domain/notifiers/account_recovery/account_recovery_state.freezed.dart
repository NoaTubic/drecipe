...
mixin _$AccountRecoveryState {
  ...
  Option<Either<Failure, Unit>> get recoverySuccessOrFailure =>
...
abstract class $AccountRecoveryStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<Failure, Unit>> recoverySuccessOrFailure});
}
...
class _$_AccountRecoveryState implements _AccountRecoveryState {
  ...
  @override
  final Option<Either<Failure, Unit>> recoverySuccessOrFailure;
