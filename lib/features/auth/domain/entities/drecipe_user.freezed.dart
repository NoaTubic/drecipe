...
DrecipeUser _$DrecipeUserFromJson(Map<String, dynamic> json) {
  return _DrecipeUser.fromJson(json);
}
...
class _$_DrecipeUser implements _DrecipeUser {
  ...
  factory _$_DrecipeUser.fromJson(Map<String, dynamic> json) =>
      _$$_DrecipeUserFromJson(json);
...
abstract class _DrecipeUser implements DrecipeUser {
  ...
  factory _DrecipeUser.fromJson(Map<String, dynamic> json) =
      _$_DrecipeUser.fromJson;
